...
=== Support for plugins ===
   ...
   * WP-PostRatings (http://lesterchan.net/portfolio/programming/php/#wp-postratings)
...
==== Future Plans ====
   ...
   * Replace WP-PostRatings code with support for gd-ratings
...
==== License ====
Dragonskin (WordPress Theme)
Copyright (C) 2008,2009 - Angelo Bertolli
